...
export const FIELD_TAG_LABELS = {
  ...
  [FIELD_TAGS.APPLICATION_STATUS]: 'Application Status',
...
export const HEADER_ALIASES = {
  ...
  'application status': FIELD_TAGS.APPLICATION_STATUS,
  status: FIELD_TAGS.APPLICATION_STATUS,
